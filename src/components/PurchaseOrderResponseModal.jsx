...
// // Leaflet map component (keeping the same as before)
// const PlotMap = ({ selectedPlots, availablePlots }) => {
//   const mapContainerRef = useRef(null);
//   const leafletMapRef = useRef(null);
//   const plotsLayerRef = useRef(null);
...
// // Land Plot Upload Component with forwardRef
// const LandPlotUploadDialogs = React.forwardRef(({ onSuccess }, ref) => {
...
//   const [poDetails, setPODetails] = useState(null);
//   const [showValidation, setShowValidation] = useState(false);
//   const uploadDialogsRef = useRef(null);
...
//                   onClick={() => {
//                     console.log('Create button clicked', uploadDialogsRef.current);
//                     if (uploadDialogsRef.current) {
//                       uploadDialogsRef.current.openCreate();
//                     }
//                   }}
//                 >
//                   Create Plot
...
//                   startIcon={<Upload />}
//                   onClick={() => {
//                     console.log('Import button clicked', uploadDialogsRef.current);
//                     if (uploadDialogsRef.current) {
//                       uploadDialogsRef.current.openImport();
//                     }
//                   }}
//                 >
//                   Import CSV
...
//                   Create a new land plot or import multiple plots from CSV using the buttons above
//                 </Typography>
//               </Box>
//             ) : (
//               <>
...
//             {/* Hidden upload dialogs component */}
//             <LandPlotUploadDialogs 
//               ref={uploadDialogsRef}
//               onSuccess={loadPODetails} 
//             />
//           </Box>
//         );

//       case 2:
//         // ... (same as before - production dates)
//         return (
//           <Box>
//             <Typography variant="h6" gutterBottom>Production Date Configuration</Typography>
//             {/* ... rest of step 2 code from previous version ... */}
//           </Box>
//         );

//       case 3:
//         // ... (same as before - select products)
//         return (
//           <Box>
//             <Typography variant="h6" gutterBottom>Select Products</Typography>
//             {/* ... rest of step 3 code from previous version ... */}
//           </Box>
//         );
...
//         <Box>
//           <Typography variant="h5" gutterBottom>Purchase Order Response - {purchaseOrderNumber}</Typography>
//           <LinearProgress variant="determinate" value={((currentStep + 1) / steps.length) * 100} sx={{ mt: 1 }} />
//         </Box>
//       </DialogTitle>
